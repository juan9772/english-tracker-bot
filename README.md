...
* 🧠 **Natural Language Processing (Gemini 2.5 Flash):** Understands both explicit commands (`/done`, `/shield`, `/status`) and casual conversations in Spanish/English (e.g., *"today I learned I went to the store"*, *"I need a shield today"*).
